...
/**
 * Servlet implementation class BankValidation
 */
@WebServlet("/BankValidation")
public class BankValidation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			pw.write("<h1>Registration Complete</h1>");
